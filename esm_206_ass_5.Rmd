...
ggplot(data = vertebrates_section, aes(x = year, y = n, color = sectionname)) +
  ...
  labs(x = "Year",
       y = "Salamander Count",
       title = "Pacific Giant Salamanders observed in different forest types, 1993-2017",
       color = 'Forest Type') 
```
...
To begin, we first created a table of the counts of salamanders found in three distinct channel areas designated by this study. We excluded 'isolated pool' salamanders to control solely for salamanders found in-stream. The table of counts and the proportion for that type of forest section that the count for that channel area represents can be found below in Figure 3. 
